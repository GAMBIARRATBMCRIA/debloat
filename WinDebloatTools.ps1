...
function Main() {
    ...
    Begin {
        ...
        $Host.UI.RawUI.WindowTitle = '🚀 Ferramenta de Otimizacao Windows'
    }
    ...
    Process {
        ...
        If ("$pwd" -notlike "$PSScriptRoot") {
            Write-Style "Local errado detectado, mudando para pasta de script! ($pwd)" -Color Yellow -BackColor Black -Style Bold
...
function Show-GUI() {
    Write-Status -Types "@", "UI" -Status "Abrindo GUI Layout..."
    # Loading System Libs
    ...
    # ==> T1 Panel 1
    $ClCustomizeFeatures = New-Label -Text "Custom Caracteristicas Sistema" -Width $LayoutT1.PanelElementWidth -Height $LayoutT1.CaptionLabelHeight -LocationX $LayoutT1.PanelElementX -LocationY 0 -FontSize $LayoutT1.Heading[2] -FontStyle 'Bold'
    
 
    $CbDarkTheme = New-CheckBox -Text "Habilitar tema Escuro" -Width $LayoutT1.PanelElementWidth -Height $LayoutT1.CheckBoxHeight -LocationX $LayoutT1.PanelElementX -FontSize $LayoutT1.Heading[3] -ElementBefore $ClCustomizeFeatures
    ...
    # ==> T1 Panel 2
    $ClDebloatTools = New-Label -Text "Alterações de Sistema" -Width $LayoutT1.PanelElementWidth -Height $LayoutT1.CaptionLabelHeight -LocationX $LayoutT1.PanelElementX -LocationY 0 -FontSize $LayoutT1.Heading[2] -FontStyle 'Bold'
    #
    $ApplyTweaks = New-Button -Text "Aplicar Ajustes" -Width $LayoutT1.PanelElementWidth -Height $LayoutT1.ButtonHeight -LocationX $LayoutT1.PanelElementX -ElementBefore $ClDebloatTools -FontSize $LayoutT1.Heading[3] -FontStyle 'Bold' -ForeColor $Colors.Cyan
    #
    $UndoTweaks = New-Button -Text "Desfazer Ajustes" -Width $LayoutT1.PanelElementWidth -Height $LayoutT1.ButtonHeight -LocationX $LayoutT1.PanelElementX -FontSize $LayoutT1.Heading[3] -ElementBefore $ApplyTweaks -MarginTop $LayoutT1.DistanceBetweenElements -ForeColor $Colors.WarningYellow
    $DiskCleanUp = New-Button -Text "Limpeza de Disco" -Width $LayoutT1.PanelElementWidth -Height $LayoutT1.ButtonHeight -LocationX $LayoutT1.PanelElementX -FontSize $LayoutT1.Heading[3] -ElementBefore $UndoTweaks -MarginTop $LayoutT1.DistanceBetweenElements -ForeColor $Colors.Cyan
    ...
    $CbWindowsHello = New-CheckBox -Text "Windows Hello" -Width $LayoutT1.PanelElementWidth -Height $LayoutT1.CheckBoxHeight -LocationX $LayoutT1.PanelElementX -FontSize $LayoutT1.Heading[3] -ElementBefore $CbWindowsSandbox

    $ClTaskScheduler = New-Label -Text "Task Scheduler" -Width $LayoutT1.PanelElementWidth -Height $LayoutT1.CaptionLabelHeight -LocationX $LayoutT1.PanelElementX -FontSize $LayoutT1.Heading[2] -FontStyle 'Bold' -ElementBefore $CbWindowsHello
    ...
    $T1Panel3.Controls.AddRange(@($ClOptionalFeatures, $CbHyperV, $CbInternetExplorer, $CbPrintToPDFServices, $CbPrintingXPSServices, $CbWindowsMediaPlayer, $CbWindowsSandbox, $CbWindowsHello))
    ...
    $CbWindowsHello.Add_Click( {
            If ($CbWindowHello.CheckState -eq "Checked") {
                Remove-WindowsCapability -Online -Name "Hello.Face*"
                $CbWindowHello.Text = "[ON]  Windows Hello"
            } Else {
                Remove-WindowsCapability -Online -Name "Hello.Face*"
                $CbWindowsHello.Text = "[OFF] Windows Hello"
            }
        })
