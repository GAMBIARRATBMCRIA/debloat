...
function Optimize-TaskScheduler() {
    ...
    $DisableScheduledTasks = @(
        ...
        ############################### novas tarefas adicionadas por GAMBIARRA #######

        "\Microsoft\Windows\Power Efficiency Diagnostics\AnalyzeSystem"
        "\Microsoft\Windows\Defrag\ScheduledDefrag"
        #"\Microsoft\Windows\WindowsUpdate\Scheduled Start"                               #Habilitar para nao iniciar o Win Updade quando tiver internet
    ...
    Write-Title "Ajustes no agendador de tarefas"
    Write-Section "Desativando tarefas agendadas do Windows"

    If ($Revert) {
        Write-Status -Types "*", "TaskScheduler" -Status "A reversão dos ajustes está definida como '$Revert'." -Warning
    ...
    Write-Section "Habilitando tarefas agendadas no Windows"
