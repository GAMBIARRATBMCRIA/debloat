...
function Optimize-ServicesRunning() {
    ...
    $ServicesToDisabled = @(
        ...
        "Themes"                                    #Fornece gerenciamento de temas para experiência do usuário.
        "GoogleUpdaterInternalService128.0.6537.0"
        "GoogleUpdaterService128.0.6537.0"
        "InstallService"                            #Fornece suporte de infraestrutura para a Microsoft Store.
        "MicrosoftEdgeElevationService"
        "DoSvc"                                     #Executa tarefas de otimização de entrega de conteúdo
        "brave"
        "bravem"
        "WaaSMedicSvc"
        "wuauserv"
    ...
    Write-Title "Ajustes de serviços"
    Write-Section "Desabilitando serviço do Windows"
    ...
    Write-Section "Habilitando serviços do Windows"
